// Package gl provides CGO-less OpenGL 3.3 compatibility-profile bindings for Go.
//
// This package is a drop-in replacement for github.com/go-gl/gl/v3.3-compatibility/gl.
...
// instead.
//
//go:generate go run ../../cmd/glgen/ -ver 3.3 -out . -ext -compat
package gl
